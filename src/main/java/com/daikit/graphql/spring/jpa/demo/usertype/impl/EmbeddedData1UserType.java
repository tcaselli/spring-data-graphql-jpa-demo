 ...
 */
public class EmbeddedData1UserType extends AbstractJsonUserType<EmbeddedData1> {

	/**
	 * Name of this user type
	 */
	public static final String NAME = "com.daikit.graphql.spring.jpa.demo.usertype.impl.EmbeddedData1UserType";
