...
import com.daikit.graphql.spring.jpa.demo.usertype.impl.EmbeddedData1ListUserType;
import com.daikit.graphql.spring.jpa.demo.usertype.impl.EmbeddedData1UserType;
import com.daikit.graphql.spring.jpa.demo.usertype.impl.Enum1ListUserType;
import com.daikit.graphql.spring.jpa.demo.usertype.impl.Enum1SetUserType;
import com.daikit.graphql.spring.jpa.usertype.StringListUserType;
import com.daikit.graphql.spring.jpa.usertype.StringSetUserType;
...
public class Entity1 extends AbstractEntity {
	...
	@Type(type = StringListUserType.NAME)
	private List<String> stringList = new ArrayList<>();

	@Column(nullable = false)
	@Type(type = StringSetUserType.NAME)
	...
	@Column(nullable = false)
	@Type(type = Enum1ListUserType.NAME)
	private List<Enum1> enumList = new ArrayList<>();

	@Column(nullable = false)
	@Type(type = Enum1SetUserType.NAME)
	...
	// Single data
	@Column(nullable = false)
	@Type(type = EmbeddedData1UserType.NAME)
	private EmbeddedData1 embeddedData1;

	// List of datas
	@Column(nullable = false)
	@Type(type = EmbeddedData1ListUserType.NAME)
